# Verify/Check Mode for `setup-anovickis-skills`

This project will not add a dedicated verify/check mode (or a separate verify skill) for `setup-anovickis-skills`.
...
- #106 — Feature request: verify/check mode for setup-anovickis-skills
